                    ...
                    video.type === "local" ? (
                      ...
                      <div key={video.id} className="flex flex-col">
                        <a
                          ...
                          className="group relative aspect-video w-full overflow-hidden bg-black border border-white/10"
                          aria-label={video.title || "Video de YouTube"}
                        >
                          {video.thumbnailUrl && (
                            <Image
                        ...
                        >
                          <h3 className="text-xs uppercase font-mono text-white/90 tracking-wider hover:text-raveRed transition-colors">
                            {video.title}
                          </h3>
                        </a>
                      </div>
              ...
              <div className="flex flex-col divide-y divide-white/10 border border-raveBorder bg-panel/30 mb-8 lg:mb-0">
                {column1.map((artist, colIndex) => {
                  ...
                  return (
                    <article
                      key={artist.id}
                      className="group relative flex items-center justify-between py-2.5 sm:py-3 px-3.5 sm:px-4 border-b border-white/10 transition-all duration-200 hover:bg-black/90 hover:border-l-4 hover:border-l-raveRed"
                    >
