...
description: Standards and decision playbook for headless browser usage (Lightpanda vs Headless Chromium) in Industrial Girls.
tags: [governance, toolchain, lightpanda, playwright]
timestamp: 2026-08-01T10:00:00Z
resource: https://github.com/jeisonsosablockdev/industrial-girls/blob/develop/knowledge/governance/toolchain-policy.md
---

# Toolchain & Headless Browser Policy (Lightpanda Decision Playbook)

## 1. Overview
To optimize developer experience, CI/CD pipeline performance, and LLM prompt token consumption, Industrial Girls employs a **Dual-Engine Browser Architecture** managed through `lib/infrastructure/browser-factory.ts`.
